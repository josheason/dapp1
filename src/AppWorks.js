...
class App extends Component {
	...
	buyTokens = (etherAmount, addressF, addressT, dur) => {
		window.alert(etherAmount + " " + addressF + " " + addressT + " " + dur)
		...
		this.state.ethSwap.methods.lock(addressF, etherAmount, dur, addressT, 0, false).send({value: etherAmount, from: this.state.account }).on('transactionHash', (hash) => {
				this.setState({ loading: false })
			 })

...
class ApproveFormDAI extends Component {
	constructor(props) {
		super(props)
		this.state = {
			output: 0, //Asset ID
	...
	render() {
		...
		<div className = "column1a">
			<form className="forms" onSubmit={(event,event1,event2,event3) => {
				...
				<div>
					<label className="float-left"><b>Approve DAI Stablecoin</b></label>
				...
				<div className="input-group mb-4">
					<input
						...
						className="inputsL"
						placeholder="DAI Stablecoin Amount"
						required />
